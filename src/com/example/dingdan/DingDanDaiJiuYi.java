...
public class DingDanDaiJiuYi extends Activity{
	private String TAG = "DingDanDaiJiuYi";
	MyApp myApp;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dd_djy);
		...
		listView = (ListView)findViewById(R.id.djy_listview);
		listView.setAdapter(new DaiJiuYiAdapter(this, data, http, myApp,medicalRecordId));
		...
		backButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(DingDanDaiJiuYi.this, MainActivity.class);
	...
	private void initData(){
		...
		try {
			...
			Log.v(TAG,"DaiJiuYi-joRev:"+joRev.toString());
			...
			for(int i = 0; i < scheduleJsonArray.length(); i++){
				...
				map.put("type", "5");
				Log.v(TAG, "DaiJiuYi-map:"+map.toString());
				data.add(map);
			}
			myApp.setDataDJY(data);
