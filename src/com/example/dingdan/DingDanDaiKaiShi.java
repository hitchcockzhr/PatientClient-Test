...
public class DingDanDaiKaiShi extends Activity{
	private String TAG = "DingDanDaiFuKuan";
	MyApp myApp;
	String getDaiKaiShiString = "shlc/patient/medicalRecords/status/NOT_STARTED";
	//String getDaiKaiShiString = "shlc/patient/medicalRecords/status/WAITING_FOR_PATIENT";
	String http, httpUrl;
	JSONObject joRev;
	...
	DaiKaiShiAdapter daiKaiShiAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dd_dks);
		...
		listView = (ListView)findViewById(R.id.dks_listview);
		daiKaiShiAdapter = new DaiKaiShiAdapter(this, data, http, myApp);
		listView.setAdapter(daiKaiShiAdapter);
		daiKaiShiAdapter.notifyDataSetChanged();
		...
		backButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(DingDanDaiKaiShi.this, MainActivity.class);
