...
public class DingDanQuanBu extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setAdapter(new QuanBuAdapter(this, data, http, myApp,medicalRecordId));
		...
		backButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(DingDanQuanBu.this, MainActivity.class);
