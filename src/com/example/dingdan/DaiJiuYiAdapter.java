...
public class DaiJiuYiAdapter extends BaseAdapter{
	String TAG = "DaiJiuYiAdapter";
	...
	private MyApp myApp;
	public DaiJiuYiAdapter(Context context,  List<HashMap<String,String>> data, String http, MyApp myApp, String medicalRecordId) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			viewHolder.jiuyiButton = (Button)convertView.findViewById(R.id.jiuyi_btn);
		...
		viewHolder.jiuyiButton.setOnClickListener(new OnClickListener() {
