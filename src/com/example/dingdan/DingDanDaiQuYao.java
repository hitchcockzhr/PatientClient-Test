...
public class DingDanDaiQuYao extends Activity{
	private String TAG = "DingDanDaiQuYao";
	MyApp myApp;
	...
	DaiQuYaoAdapter daiquyaoAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dd_dqy);
		...
		listView = (ListView)findViewById(R.id.dqy_listview);
		daiquyaoAdapter = new DaiQuYaoAdapter(this, data, http, myApp);
		listView.setAdapter(daiquyaoAdapter);
		daiquyaoAdapter.notifyDataSetChanged();
		...
		backButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(DingDanDaiQuYao.this, MainActivity.class);
