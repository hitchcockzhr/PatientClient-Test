...
public class DingDanDaiPingJia extends Activity{
	private String TAG = "DingDanDaiPingJia";
	MyApp myApp;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dd_dpj);
		myApp = (MyApp)getApplication();
		jsonList = myApp.getJsonList();
		http = myApp.getHttp();
		initData();
		sortDataByCreateTime();
		listView = (ListView)findViewById(R.id.dpj_listview);
		listView.setAdapter(new DaiPingJiaAdapter(this, data));
		...
		backButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = new Intent(DingDanDaiPingJia.this, MainActivity.class);
