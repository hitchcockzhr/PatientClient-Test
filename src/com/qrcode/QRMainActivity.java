    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        scanBarCodeButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent openCameraIntent = new Intent(QRMainActivity.this,CaptureActivity.class);
			...
			public void onClick(View v) {
				try {
					...
					if (!contentString.equals("")) {
						...
						Toast.makeText(QRMainActivity.this, "Text can not be empty", Toast.LENGTH_SHORT).show();
					}
